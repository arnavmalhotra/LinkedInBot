...
with tab1:
    ...
    - Enter the **Hunter API Key** to enable email search.
        To find your Hunter API Key, login to your Hunter.io Account, select API under the integration tab on the left and copy the key provided.
    - Check the **Search Results** tab for profiles. (Takes a few seconds to load after the popup)
    - If no email is found, use the **Search with Hunter** (If you provided an API key) option.
